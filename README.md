# TIC-TAC-TOE-GAME-USING-TKINTER-ON-PYTHON-3-
...
root.title("~~~~~~~TIC TAC TOE BY SUDIP~~~~~~~")
...
labelTitle=Label(Tops,font=("arial",50,"bold"),text="Advanced Tic Tac Toe Game",bd=21,bg="Cadet Blue",fg="cornsilk",justify=CENTER)
...
def scorekeeper():
    ...
    if button1["text"]=="X" and button2["text"]=="X" and button3["text"]=="X":
        ...
        tkinter.messagebox.showinfo("Winner!","Player-X You Won the match!")
    ...
    if button1["text"]=="O" and button2["text"]=="O" and button3["text"]=="O":
        ...
        tkinter.messagebox.showinfo("Winner!","Player-O Won the match!")
        ...
        tkinter.messagebox.showinfo("Winner!", "Player-O You Won the match!")
...
PlayerXLabel=Label(RightFrame1,font=("arial",40,"bold"),text="Player X",padx=2,pady=2,bd=21,bg="Cadet Blue")

PlayerXLabel.grid(row=0,column=0,sticky=W)
...
Player0Label=Label(RightFrame1,font=("arial",40,"bold"),text="Player 0",padx=2,pady=2,bd=21,bg="Cadet Blue")

Player0Label.grid(row=1,column=0,sticky=W)
...
btnNew=Button(RightFrame2,text="New Game",font=("Times 26 bold"), height=1,width=20,command=newGame)
